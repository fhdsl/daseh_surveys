...
sd_question(
  type  = "mc",
  id    = "role",
  label = "**Which best describes your current role?**\n\n*If you choose 'Other', an optional comment box will appear.*",
  option = c(
    "Student" = "student",
...
sd_question(
  type = "mc_multiple",
  id = "concerns",
  label = "**What are your concerns about this course?**\n\n*Select any that apply. You may also use the 'Other' option, and use the optional comment box to explain further.*",
  option = c(
