...
server <- function(input, output, session) {
  ...
  sd_show_if(
    ...
    input$academic_institution == "yes" ~ "academic_institution_more",
    input$academic_institution == "no" ~ "organization",
    "other" %in% input$academic_institution_more ~ "academic_institution_more_other",
    "other" %in% input$organization ~ "organization_other",
    "other" %in% input$concerns ~ "concerns_other",
    "other" %in% input$benefits ~ "benefits_other"
  )
